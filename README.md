...
# 🎮 Sort Them Ducks — Community Edition

**A relaxing duck-sorting puzzle, ready to play offline.**
...
Sort Them Ducks is a casual puzzle game in which players arrange colorful ducks into matching groups across increasingly complex levels. Each stage introduces new mechanics, from mixed duck types to limited perches, encouraging logical planning. This Community Edition is a standalone build supplied as a self-contained package with no storefront required and no additional software required.

This build is intended for casual puzzle players who want an offline, self-contained version of Sort Them Ducks for Windows PCs.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4992070/851c391a8308796251755e798724483b7b3bee39/ss_851c391a8308796251755e798724483b7b3bee39.1920x1080.jpg?t=1787671820" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4992070/fd52600c2ff71077c4de7489cd707c9cd14e206c/ss_fd52600c2ff71077c4de7489cd707c9cd14e206c.1920x1080.jpg?t=1787671820" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4992070/67cf163c916672c18e56cb66d6ca94e741d3ada6/ss_67cf163c916672c18e56cb66d6ca94e741d3ada6.1920x1080.jpg?t=1787671820" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🦆 **Duck Sorting Gameplay** — Move and group ducks by color and type across dozens of hand-designed levels.
- 🧩 **Progressive Puzzles** — Difficulty ramps up gradually with new mechanics introduced at a steady pace.
- 🖱️ **Simple Controls** — Fully playable with mouse only — point, click, and sort.
- 🎵 **Relaxing Presentation** — Soft soundtrack and gentle visuals suited to casual, low-pressure sessions.
- 💾 **Lightweight Footprint** — Small install size and low hardware demands for older systems.
- 🌐 **Offline Play** — Runs entirely offline as a self-contained package with no account needed.
- ⏱️ **Short Sessions** — Levels are designed for quick play sessions with instant restarts.
- 📊 **Level Tracking** — Progress and completion stats are saved locally on your machine.
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | Intel HD Graphics 4000 or DirectX 11 compatible GPU | NVIDIA GeForce GTX 750 or AMD Radeon R7 260X |
| **Storage** | 500 MB available space | 1 GB available space |
| **Additional** | Keyboard and mouse | Audio output device for soundtrack |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\SortThemDucks\Saved`
